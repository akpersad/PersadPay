...
import type { PaystubWithYTD, Settings, W2 } from '@/lib/types'
...
export async function generateStubPDF(
  ...
  const doc = React.createElement(PaystubDocument, { stub, settings, variant }) as React.ReactElement<DocumentProps>
