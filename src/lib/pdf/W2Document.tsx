...
const NOTICE_TO_EMPLOYEE = [
  ...
  'Earned income credit (EIC). You may be able to take the EIC for 2026 if your adjusted gross income (AGI) is less than a certain amount. The amount of the credit is based on income and family size. Workers without children could qualify for a smaller credit. You and any qualifying children must have valid Social Security numbers (SSNs). You can\'t take the EIC if your investment income is more than the specified amount for 2026 or if income is earned for services provided while you were an inmate at a penal institution.',
  ...
  'Credit for excess taxes. If you had more than one employer in 2026 and more than $11,439.30 in social security and/or Tier 1 railroad retirement (RRTA) taxes were withheld, you may be able to claim a credit for the excess against your federal income tax. If you had more than one railroad employer and more than $6,844.80 in Tier 2 RRTA tax was withheld, you also may be able to claim a credit. See your Form 1040 or 1040-SR instructions and Pub. 505, Tax Withholding and Estimated Tax.',
]
