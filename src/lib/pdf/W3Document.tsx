      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.callout}>
          <Text style={styles.calloutText}>
            ...
            (Business Services Online) generates a W-3 automatically from your W-2 upload. A paper
            W-3 is not required when filing through BSO.{'\n'}
        ...
        {/* Box letters follow the official W-3: b Kind of payer, c number of
            W-2s, e EIN, f employer name, g address. (a is Control number and
            d is Establishment number — both unused here.) */}
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoBlock}>
            <Text style={styles.infoLabel}>Box e · EIN</Text>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoBlock}>
            <Text style={styles.infoLabel}>Box f · Employer name</Text>
            <Text style={styles.infoValue}>{settings.employer_name ?? '—'}</Text>
          </View>
          <View style={styles.infoBlock}>
            <Text style={styles.infoLabel}>Box g · Address</Text>
